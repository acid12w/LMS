  ...
  if (!data) {
    return < div className="w-screen h-screen flex justify-center items-center">
                <div role="status">
                    ...
                    <span NameName="sr-only">Loading...</span>
                </div>
          </div>
  }
  ...
  return (
    <div>
      ...
      <article className="p-6">
        <div className=" w-full sm:w-2/3 m-auto mb-8">
          <h4 className="mb-4 text-lg font-bold">Intro Video</h4>
          <YoutubeEmbed embedId="https://www.youtube.com/watch?v=d_BhzHVV4aQ&ab_channel=TraversyMedia" width={100} height={580}/>
        </div>
