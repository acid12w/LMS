...
export const SideNav = ({ setToggleSideNav, toggleSideNav }) => {
  ...
  content = <nav className="w-75 h-full w-full relative">
    <button type="button" onClick={() => setToggleSideNav(!toggleSideNav)} class="absolute right-[0] text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 absolute top-2.5 end-2.5 inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" >
